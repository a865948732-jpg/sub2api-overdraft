...
func (s *OpenAIGatewayService) ForwardAsAnthropic(
	...
	// Apply the group-scoped prompt before selecting the Responses or raw Chat
	// fallback. The marker in applyOpenAIGroupPromptToBody keeps recursive
	// failover paths idempotent.
